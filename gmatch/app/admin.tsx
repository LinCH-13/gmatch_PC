...
export default function regorg() {
  ...
  const apiKey = "taFuwkAoePReSjjcQ4AnuOzh2EBmTGCZIQeb3PyFPA8fAzFurZ8x_w==";
  const apiUrl =
  ...
  const handleRegOrg = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        setError("");
        setMessage("register ORG successful !");
    ...
    >
      ...
      >
        ...
        <ThemedView style={styles.loginContainer}>
          ...
          <Button title="登録" onPress={handleRegOrg} />
          {message ? (
